...
import lightFullLogo from "../imgs/logo.jpeg";
...
const PageNotFound = () => {
    ...
    return (
        <section className="h-cover relative p-10 flex flex-col items-center gap-20 text-center">
            ...
            <img src={lightPageNotFoundImg } className="select-none border-2 border-grey w-72 aspect-square object-cover rounded" />
            ...
            <div className="mt-auto">
                <img src={lightFullLogo } className="h-8 object-contain block mx-auto select-none" />
